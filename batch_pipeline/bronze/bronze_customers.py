...
def get_session():
    spark = (
        ...
        .appName("Medallion_Bronze_Customers_Processing")
        .config(
...
def main():
    ...
    print("Starting Bronze ingestion for customers...")
    ...
    spark.stop()
    print(f"Successfully ingested customers into Bronze layer at {bronze_output_path}")
