...
def get_session():
    spark = (
        ...
        .appName("Medallion_Bronze_Sales_Processing")
        .config(
...
def main():
    ...
    print("Starting Bronze ingestion for sales...")
    ...
    spark.stop()
    print(f"Successfully ingested sales into Bronze layer at {bronze_output_path}")
